...
func (in *BackendStatus) DeepCopyInto(out *BackendStatus) {
	*out = *in
	...
	if in.DriveAssignments != nil {
		in, out := &in.DriveAssignments, &out.DriveAssignments
		*out = make(map[DriveName]*v1.LocalObjectReference, len(*in))
		for key, val := range *in {
			var outVal *v1.LocalObjectReference
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
	...
	if in.CoreAssignments != nil {
		in, out := &in.CoreAssignments, &out.CoreAssignments
		*out = make(map[CoreId]*v1.LocalObjectReference, len(*in))
		for key, val := range *in {
			var outVal *v1.LocalObjectReference
			if val == nil {
				(*out)[key] = nil
...
func (in *ContainerStatus) DeepCopyInto(out *ContainerStatus) {
	*out = *in
	in.AssignedNode.DeepCopyInto(&out.AssignedNode)
}
