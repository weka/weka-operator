...
- Names should be generated in step separate from provisioning this names, to allow for retries without regenerating names and creating duplicate resources
...
- before running long polling/wait commands - validate the field that you plan to watch exists. Prefer watching for fields and not for conditions
