...
| netmask | int | The data-path netmask for the backend containers’ network, expressed as prefix bits (for example, 24).<br>This is only necessary when the netmask cannot be inferred from deviceSubnets. |
