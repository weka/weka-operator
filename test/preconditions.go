...
func (p *Precondition) Run(ctx context.Context) func(t *testing.T) {
	return func(t *testing.T) {
		t.Run("Is Debug", p.IsDebug(ctx))
		t.Run("Ping", p.Ping(ctx))
		t.Run("Backend Nodes", p.BackendNodes(ctx))
		t.Run("Builder Node", p.BuilderNode(ctx))
	}
}

func (st *Precondition) IsDebug(ctx context.Context) func(t *testing.T) {
	return func(t *testing.T) {
...
func (st *Precondition) Ping(ctx context.Context) func(t *testing.T) {
	return func(t *testing.T) {
...
func (st *Precondition) BackendNodes(ctx context.Context) func(t *testing.T) {
	return func(t *testing.T) {
...
func (st *Precondition) BuilderNode(ctx context.Context) func(t *testing.T) {
	return func(t *testing.T) {
